...
?> 
 <form class="form-horizontal span6" action="controller.php?action=edit" method="POST">
              ...
              <div class="row">
         <div class="col-lg-12">
            <h1 class="page-header">Modifier la catégorie</h1>
          </div> 
       </div> 
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                       <input  id="CATEGID" name="CATEGID"   type="HIDDEN" value="<?php echo $singlecategory->CATEGARID; ?>">
                         <input class="form-control input-sm" id="CATEGORY" name="CATEGORY" placeholder=
                            "Catégorie" type="text" value="<?php echo $singlecategory->CATEGORIES; ?>">
                      </div>
                    </div>
                  </div>
