        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" >Nazih E-Commerce</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right"> 
                 <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="<?php echo web_root; ?>admin/category/index.php?view=add"><i class="fa fa-list-alt  fa-fw"></i> Catégorie</a>
                        </li>
                        <li><a href="<?php echo web_root; ?>admin/categoryAr/index.php?view=add"><i class="fa fa-list-alt  fa-fw"></i> CatégorieArabe</a>
                        </li>
                            <?php if ($_SESSION['U_ROLE']=='Administrator') {
                            # code...
                        ?>
                         <li><a href="<?php echo web_root; ?>admin/user/index.php?view=add"><i class="fa fa-user  fa-fw"></i> Utilisateur</a>
                            </li>
                        <?php }?>
...
?> 
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        Bonjour, <?php echo $_SESSION['U_NAME']; ?> <img title="profile image" width="23px" height="17px" src="<?php echo web_root.'admin/user/'.$singleuser ->USERIMAGE ?>">  
                ...
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <!--     <li>
                        ...
                        <li>
                         ...
                         <li>
                             <a href="<?php echo web_root; ?>admin/category/index.php" ><i class="fa fa-list-alt fa-fw"></i>  Catégories Fr </a>
            
                        </li>
                        <li>
                             <a href="<?php echo web_root; ?>admin/categoryAr/index.php" ><i class="fa fa-list-alt fa-fw"></i>  Catégories Ar </a>
                        ...
                        ?>
                         <li>
                             <a href="<?php echo web_root; ?>admin/settings/index.php" ><i class="fa fa-list-alt fa-fw"></i>  Réglage </a>
                       ...
                       <!--   <li>
                          ...
                          <li>
                            <a href="<?php echo web_root; ?>admin/user/index.php" ><i class="fa fa-user fa-fw"></i> Utilisateurs </a>
