<?php
		...
		<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header">Liste des produits  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> New</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
			  ...
			  <tbody>
				    ...
				    echo '<td style="padding:0px;">
				  		...
				  		echo '<td>  '.  number_format($result->PRODISPRICE,2).' Dhs</td>';
