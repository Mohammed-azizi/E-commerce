        ...
        <div class="row">
          ...
          <div class="col-md-8 clearfix">
            <div class="shop-menu clearfix pull-left">
              <ul class="nav navbar-nav">     
                <li><a href="<?php echo web_root;?>index.php?q=cart"><i class="fa fa-shopping-cart"></i> عربة التسوق</a></li>
                <?php if (isset($_SESSION['CUSID'] )) { ?>  
                  <li><a href="<?php echo web_root?>index.php?q=profile"><i class="fa fa-user"></i> تسجيل الدخول</a></li>     
