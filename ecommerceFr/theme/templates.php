...
<head>
    ...
    <title>Accueil | Ecom-Nazih</title>
          ...
          <div class="col-sm-4">
            <div class="contactinfo">
              <ul class="nav nav-pills pull-right">
                <li><a href="<?php echo web_root?>">Arabe</a></li>
                <li><a href="<?php echo web_root?>ecommerceFr">Français</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>ecommerceFr"><img src="images/home/log.png" alt="" /></a>
            </div> 
          </div>
          <div class="col-md-8 clearfix">
            <div class="shop-menu clearfix pull-right">
              <ul class="nav navbar-nav">     
                <li><a href="<?php echo web_root;?>ecommerceFr/index.php?q=cart"><i class="fa fa-shopping-cart"></i> Caddie</a></li>
                <!-- <?php if (isset($_SESSION['CUSID'] )) { ?>  
                  <li><a href="<?php echo web_root?>ecommerceFr/index.php?q=profile"><i class="fa fa-user"></i> Account</a></li>     
                  <li><a   href="<?php echo web_root?>ecommerceFr/logout.php"><i class="fa fa-lock"></i> Logout</a></li>
                <?php }else{ ?> 
          ...
          <div class="col-sm-9">
            ...
            <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                <li><a href="<?php echo web_root;?>ecommerceFr" class="active">Accueil</a></li>
                ...
                <!-- <li><a href="<?php web_root?>ecommerceFr/index.php?q=contact">Contact</a></li> -->
              </ul>
            </div>
          </div>
          <div class="col-sm-3">
            <form action="<?php echo web_root?>ecommerceFr/index.php?q=product" method="POST" > 
              <div class="search_box pull-right">
               <!-- Chercher un produit,une marque ou une catégorie -->
                <input type="text" name="search" placeholder="Chercher un produit..."/>
