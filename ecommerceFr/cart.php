...
?>
             ...
             ';
                                  ...
                                  <td>
                                    ...
                                    <?php echo  $result->PRODISPRICE ; ?> DH
                                  </td>
                                  <td class="input-group custom-search-form" >
                                     ...
                                     <td>  <output id="Osubtot<?php echo $result->PROID ?>"><?php echo   $_SESSION['gcCart'][$i]['price'] ; ?></output>DH</td>
                                </tr>
                        ...
                        <!-- <h3 align="right"> Total  <span id="sum">0</span> DH</h3>  -->
                        <div class="  pull-right">
                  <p align="right">
                  <H4><div style="color:orange"; >Total TTC: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="sum" >0 </span> Dhs  </div>
                 </H4> </p>
                  <p><H4>Frais de livraison non inclus pour le moment</H4></p>  
                </div>
    </div>
  </div>  
     ...
     <?php    
                  ...
                  if (isset($_SESSION['CUSID'])){  
                    ...
                    echo '<button type="submit"  name="proceed" id="proceed" class="btn btn-default check_out btn-pup pull-right">
                     ...
                     echo   '<a  class="btn btn-default check_out signup pull-right" href="index.php?q=orderdetails">
                              Proceed And Checkout
                              <i class="fa  fa-arrow-right fa-fw"></i>
                              </a>';
                  } 
