            ...
            <div class="carousel-inner">
              ...
              <div class="item active" >
                ...
                <div class="col-sm-10 pull-right" >
                  ...
                  <img style=" height: 350px; weight: 350px; " src="images/home/ECOM3.png"  alt="" />
      ...
      <div class="row">
        ...
        <div class="col-sm-9 padding-right">
          <div class="features_items"><!--features_items-->
            <h2 class="title text-center">Produits offerts</h2>
              ...
              <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                      ...
                      <button type="submit" name="btnorder" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Ajouter au caddie</button>
                    </div>
